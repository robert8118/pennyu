...
class NonMovingProductWizard(models.TransientModel):
    ...
    def get_non_moving_report(self, today, warehouse_ids, from_date, to_date):
        ...
        workbook, sheet_data, row_data = self.add_headings(warehouse_id_ls, workbook, header_bold, body_style, qty_cell_style, value_style, days_style, from_date, to_date)
        data_dict = self.prepare_data(today, warehouse_ids, from_date, to_date)
        self.print_data(data_dict, workbook, sheet_data, row_data, header_bold, body_style, qty_cell_style, value_style, days_style)
    ...
    @api.multi
    def add_headings(self, warehouse_id_ls, workbook, header_bold, body_style, qty_cell_style, value_style, days_style, from_date, to_date):
        sheet_data = {}
        row_data = {}
    ...
    @api.multi
    def print_data(self, data_dict, workbook, sheet_data, row_data, header_bold, body_style, qty_cell_style, value_style, days_style):
        column = 0
        if data_dict:
