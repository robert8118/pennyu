...
class account_invoice(models.Model):
    ...
    @api.depends('nomor_faktur_id', 'nomor_faktur_id.name', 'state', 
                 #'partner_id.code_transaction', 'partner_id.ktp', 'partner_id.npwp', 'partner_id.is_npwp','partner_id.state', 'partner_id.fp_export'
                 )
    ...
    nomor_faktur_id = fields.Many2one('nomor.faktur.pajak', string='Nomor Faktur Pajak', change_default=True, readonly=True, copy=False)
